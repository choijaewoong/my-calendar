import { HolidaysOfYear } from '../types/holiday';

export const HolidaysOfYears: HolidaysOfYear[] = [
  {
    year: 2020,
    holidayList: [
      { date: '2020-01-01', name: '새해 첫 날' },
      { date: '2020-01-24', name: '설날 연휴' },
      { date: '2020-01-25', name: '설날' },
      { date: '2020-01-26', name: '설날 연휴' },
      { date: '2020-01-27', name: '대체 공휴일' },
      { date: '2020-03-01', name: '삼일절' },
      { date: '2020-04-15', name: '국회의원 선거일' },
      { date: '2020-04-30', name: '부처님 오신 날' },
